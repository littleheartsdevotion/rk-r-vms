  ...
  return (
    <html lang="en">
      <body className="font-sans bg-surface text-text-primary antialiased">
        ...
        <script type="module" async src="https://static.rocket.new/rocket-web.js?_cfg=https%3A%2F%2Frkrvms2742back.builtwithrocket.new&_be=https%3A%2F%2Fappanalytics.rocket.new&_v=0.1.18" />
