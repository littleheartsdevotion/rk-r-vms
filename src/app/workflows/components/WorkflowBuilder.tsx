...
import { Search, Plus, ChevronDown, ChevronUp, GripVertical, Lock, Eye, EyeOff, CheckCircle, AlertTriangle, X, Save, Upload, ArrowLeft, Zap, Settings, User, Phone, Mail, CreditCard, Camera, FileText, Users, Shield, Hash, Calendar, ToggleLeft, List, Type, Star, Clipboard, Video, HelpCircle, BookOpen, Heart, Play, Clock, CheckSquare, QrCode, Printer, BadgeCheck } from 'lucide-react';
...
// ─── QR Code & Badge Generation Panel ────────────────────────────────────────

function QRBadgePanel() {
  const [expanded, setExpanded] = useState(true);
...
// ─── Output / Delivery Palette Section ───────────────────────────────────────
    ...
    <div className="flex flex-col h-full bg-surface overflow-hidden">
      ...
      <div className="flex flex-1 overflow-hidden">
        ...
        <div className="w-[260px] shrink-0 flex flex-col bg-white border-l border-border overflow-hidden">
          ...
          {/* QR & Badge Panel — shown at bottom of right panel when no field selected */}
          {!selectedField && <QRBadgePanel />}
        </div>
      </div>
